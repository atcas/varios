...
contractElement: Contract Identifier '{'  sourceElements '}' ;
...
//solidity
returnfunctionSolidity: ReturnsSolidity '(' variableDeclarationListFunctionSolidity?  ')' ;
...
modifierDeclaration
 : ModifierSolidity Identifier '(' formalParameterListSolidity? ')' '{' functionBody '-' '}'
 ;
...
functionDeclaration
 : Function Identifier '(' formalParameterListSolidity? ')' returnfunctionSolidity? '{' functionBody '}'
 ;
